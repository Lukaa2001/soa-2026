...
using Explorer.Tours.Service.Stubs;

namespace Explorer.Tours.Service;

public static class ToursServiceStartup
{
    public static IServiceCollection ConfigureToursServiceModule(this IServiceCollection services)
    {
    ...
    private static void SetupCore(IServiceCollection services)
    {
        ...
        // Cross-service dependencies: stubbed during decomposition.
        // In-scope ones (Tours -> Purchase) get a real gRPC client in Faza 7.
        services.AddScoped<IInternalEncounterService, EncounterServiceStub>();
        services.AddScoped<IInternalEncounterExecutionService, EncounterExecutionServiceStub>();
        services.AddScoped<IInternalPersonService, PersonServiceStub>();
        services.AddScoped<IInternalOrderService, OrderServiceStub>();
        services.AddScoped<IInternalShoppingCartService, ShoppingCartServiceStub>();
        services.AddScoped<IInternalShoppingSession, ShoppingSessionStub>();
        services.AddScoped<IInternalFollowersService, FollowersServiceStub>();
    }
