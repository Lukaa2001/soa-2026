...
export class TouristclubService {
  ...
  getTouristClubs() : Observable<PagedResults<TouristClub>> {
    return this.http.get<PagedResults<TouristClub>>('http://localhost:8080/api/club/touristclub');
  }
  ...
  createTouristClub(touristClub: TouristClub, imageFile: File): Observable<TouristClub> {
    ...
    return this.http.post<TouristClub>('http://localhost:8080/api/club/touristclub/' + this.authService.user$.getValue().id, formData);
  }
  
  
  getClubDetails(id : number) : Observable<TouristClub>{
    return this.http.get<TouristClub>('http://localhost:8080/api/club/touristclub/' + id);
  }
  
  updateClubDetails(touristClub : TouristClub) : Observable<TouristClub> {
    return this.http.put<TouristClub>('http://localhost:8080/api/club/touristclub/' + touristClub.id, touristClub);
  }
}
