...
export class CouponService {
  ...
  addCoupon(coupon: Coupon): Observable<Coupon> {
    return this.http.post<Coupon>(
      'http://localhost:8080/api/author/coupons/createCoupon',
      coupon
    );
  }
  ...
  deleteCoupon(hash: string): Observable<Coupon> {
    return this.http.delete<Coupon>(
      'http://localhost:8080/api/author/coupons/deleteCoupon?CouponHash=' +
        hash
    );
  }
  ...
  updateCoupon(coupon: Coupon, hash: string): Observable<Coupon> {
    return this.http.put<Coupon>(
      'http://localhost:8080/api/author/coupons/updateCoupon?couponHash=' +
        hash,
      coupon
    );
  }
  ...
  getAuthorTours(authorId: number): Observable<PagedResults<Tour>> {
    return this.http.get<PagedResults<Tour>>(
      'http://localhost:8080/api/tour/authortours?authorId=' + authorId
    );
  }

  createGiftCoupon(coupon: Coupon): Observable<Coupon> {
    return this.http.post<Coupon>(
      'http://localhost:8080/api/author/coupons/createGiftCoupon',
      coupon
    );
  }
}
